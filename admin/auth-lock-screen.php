...
<head>
    ...
    <title><?php echo $language["Lock_Screen"]; ?></title>
                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    <h5 class="mb-0"><?php echo $language["Lock_Screen"]; ?></h5>
                                    <p class="text-muted mt-2">Enter your password to unlock the screen!</p>
                                </div>
                                <div class="user-thumb text-center mb-4 mt-4 pt-2">
                                    <img src="assets/images/users/me.jpg" class="rounded-circle img-thumbnail avatar-lg" alt="thumbnail">
                                    <h5 class="font-size-15 mt-3">YOUSSEF</h5>
                                </div>
