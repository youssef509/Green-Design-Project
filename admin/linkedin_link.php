...
if ($do == 'Delete') {
    ...
    if ($id > 0) {
        $stmt = $link->prepare("DELETE FROM linkedin WHERE id=$id");                                                                       
        $stmt->execute();
...
if (empty(trim($_POST["flink"]))) {
    ...
    $sql = "SELECT id FROM linkedin WHERE link = ?";
...
$sql = "INSERT INTO linkedin (id, link, author) VALUES (?, ?, '{$_SESSION["username"]}')";
...
if ($stmt = mysqli_prepare($link, $sql)) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        header("location: linkedin_link.php");
    } else {
...
<head>
    ...
    <title>التحكم في رابط لينكدان</title>
...
<div class="contact-links-alert">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">                          
                    <h4 class="card-title">التحكم في رابط لينكدان</h4>
                    <p>
...
$result = mysqli_query($link, "SELECT * FROM linkedin");
...
if (mysqli_num_rows($result) > 0) {
  ...
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    $author = $row['author'];
?>
<div class="modal fade" id="delete-linkedin" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <a type="button" href="linkedin_link.php?do=Delete&id=<?php echo $id?>" class="btn btn-danger">تأكيد وحذف</a>
                </div>
        </div>
    </div>
</div>
              ...
              <div class="card text-center">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2 d-md-block">
                        ...
                        <a type="button" href="linkedin_link.php?do=Delete&id=<?php echo $id?>" class="btn btn-danger btn-delete" data-bs-toggle="modal" data-bs-target="#delete-linkedin" data-bs-whatever="@mdo" data-id="<?php echo $id ?>" >حذف</a>
                    </div>
                </div>
